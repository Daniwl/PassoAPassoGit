# Este documento será reponsável por mostrar os comandos para serem usados no dia a dia de commits de um projeto além dos comandos de iniciar o git em um projeto.
